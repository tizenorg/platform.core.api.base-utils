...
int i18n_udatepg_get_best_pattern(i18n_udatepg_h dtpg, const i18n_uchar *skeleton, int32_t len,
								  i18n_uchar *best_pattern, int32_t capacity,
								  int32_t *best_pattern_len)
{
	...
	UErrorCode icu_error = U_ZERO_ERROR;
	*best_pattern_len =
		udatpg_getBestPattern(dtpg, skeleton, len, best_pattern, capacity, &icu_error);
...
int32_t i18n_udatepg_get_best_pattern_with_options(i18n_udatepg_h dtpg, const i18n_uchar *skeleton,
												   int32_t length,
												   i18n_udatepg_date_time_pattern_match_options_e
												   options, i18n_uchar *best_pattern,
												   int32_t capacity)
{
	...
	UErrorCode icu_error = U_ZERO_ERROR;
	int32_t length_of_best_pattern =
		udatpg_getBestPatternWithOptions((UDateTimePatternGenerator *) dtpg, skeleton, length,
										 options, best_pattern, capacity, &icu_error);
								  ...
								  i18n_uchar *skeleton, int32_t capacity)
{
	...
	UErrorCode icu_error = U_ZERO_ERROR;
	int32_t length_of_skeleton =
		udatpg_getSkeleton((UDateTimePatternGenerator *) dtpg, pattern, length, skeleton, capacity,
						   &icu_error);
...
int32_t i18n_udatepg_get_base_skeleton(i18n_udatepg_h dtpg, const i18n_uchar *pattern,
									   int32_t length, i18n_uchar *base_skeleton, int32_t capacity)
{
	...
	UErrorCode icu_error = U_ZERO_ERROR;
	int32_t length_of_skeleton =
		udatpg_getBaseSkeleton((UDateTimePatternGenerator *) dtpg, pattern, length, base_skeleton,
							   capacity, &icu_error);
...
int32_t i18n_udatepg_add_pattern(i18n_udatepg_h dtpg, const i18n_uchar *pattern,
								 int32_t pattern_length, i18n_ubool override,
								 i18n_uchar *conflicting_pattern, int32_t capacity,
								 i18n_udatepg_date_time_pattern_conflict_e *conflict_status)
{
	...
	UErrorCode icu_error = U_ZERO_ERROR;
	*conflict_status =
		udatpg_addPattern((UDateTimePatternGenerator *) dtpg, pattern, pattern_length, override,
						  conflicting_pattern, capacity, &confliction_pattern_length, &icu_error);
...
int i18n_udatepg_set_date_time_format(const i18n_udatepg_h dtpg,
									  const i18n_uchar *date_time_format, int32_t length)
{
...
int32_t i18n_udatepg_replace_field_types(i18n_udatepg_h dtpg, const i18n_uchar *pattern,
										 int32_t pattern_length, const i18n_uchar *skeleton,
										 int32_t skeleton_length, i18n_uchar *dest,
										 int32_t dest_capacity)
{
	...
	UErrorCode icu_error = U_ZERO_ERROR;
	int32_t length_of_dest =
		udatpg_replaceFieldTypes((UDateTimePatternGenerator *) dtpg, pattern, pattern_length,
								 skeleton, skeleton_length, dest, dest_capacity, &icu_error);
													  ...
													  int32_t dest_capacity)
{
	...
	UErrorCode icu_error = U_ZERO_ERROR;
	int32_t length_of_dest =
		udatpg_replaceFieldTypesWithOptions((UDateTimePatternGenerator *) dtpg, pattern,
											pattern_length, skeleton, skeleton_length, options,
											dest, dest_capacity, &icu_error);
														...
														int32_t *pattern_length)
{
	...
	set_last_result(I18N_ERROR_NONE);
	return udatpg_getPatternForSkeleton((const UDateTimePatternGenerator *)dtpg, skeleton,
										skeleton_length, pattern_length);
}
