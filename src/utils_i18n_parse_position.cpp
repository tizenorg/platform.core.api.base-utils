...
int i18n_parse_position_create_for_field(i18n_parse_position_h *parse_position, int32_t new_index)
{
    retv_if(parse_position == NULL, I18N_ERROR_INVALID_PARAMETER);
...
int i18n_parse_position_create_form_other(i18n_parse_position_h *parse_position, const i18n_parse_position_h other)
{
    ...
    ParsePosition other_copy = *((ParsePosition *) other);
    *parse_position = &other_copy;
    retv_if(parse_position == NULL, I18N_ERROR_OUT_OF_MEMORY);
