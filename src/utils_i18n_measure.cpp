...
int i18n_measure_create(i18n_measure_h measure, const i18n_formattable_h formattable, i18n_measure_unt_h measure_unit)
{
    retv_if(formattable == NULL || measure_unit == NULL, I18N_ERROR_INVALID_PARAMETER);

    *measure = MeasureFormat((Formattable *) formattable, (MeasureUnit *) measure_unit);
...
int i18n_measure_get_number(i18n_measure_h measure, i18n_formattable_h *formattable)
{
    ...
    *formattable = (Formattable *) ((Measure *) measure)->getNumber();
...
int i18n_measure_get_unit(i18n_measure_h measure, i18n_measure_unit_h *measure_unit)
{
    ...
    *measure_unit = (MeasureUnit *) ((Measure *) measure)->getUnit();
