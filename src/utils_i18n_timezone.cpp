                                                ...
                                                i18n_timezone_id_cb cb, void *user_data)
{
    ...
    StringEnumeration *s =
        TimeZone::createTimeZoneIDEnumeration((USystemTimeZoneType) timezone_type, region,
                                              raw_offset, err);
...
int i18n_timezone_foreach_timezone_id_with_offset(int32_t raw_offset, i18n_timezone_id_cb cb,
                                                  void *user_data)
{
    retv_if(cb == NULL, I18N_ERROR_INVALID_PARAMETER);
...
int i18n_timezone_foreach_timezone_id_by_country(const char *country, i18n_timezone_id_cb cb,
                                                 void *user_data)
{
    retv_if(cb == NULL, I18N_ERROR_INVALID_PARAMETER);
...
int i18n_timezone_get_equivalent_id(const char *timezone_id, int32_t index,
...
int i18n_timezone_get_region(const char *timezone_id, char *region, int32_t *region_len,
...
{
    retv_if(timezone == NULL || raw_offset == NULL
            || dst_offset == NULL, I18N_ERROR_INVALID_PARAMETER);
...
int i18n_timezone_get_display_name_with_locale(i18n_timezone_h timezone, const char *language,
                                               const char *country, char **display_name)
{
    retv_if(timezone == NULL || display_name == NULL, I18N_ERROR_INVALID_PARAMETER);
...
int i18n_timezone_get_display_name_with_type(i18n_timezone_h timezone, i18n_ubool daylight,
...
int i18n_timezone_get_display_name_with_type_locale(i18n_timezone_h timezone, i18n_ubool daylight,
                                                    i18n_timezone_display_type_e style,
...
int i18n_timezone_has_same_rule(i18n_timezone_h timezone, i18n_timezone_h other,
