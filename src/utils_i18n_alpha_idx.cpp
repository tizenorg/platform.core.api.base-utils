...
int i18n_alpha_idx_next_bucket(i18_alpha_idx_h index, bool *is_bucket)
{
    ...
    if(is_bucket != NULL)
        *is_bucket = ((AlphabeticIndex *) index)->nextBucket(status);
    else
...
int i18n_alpha_idx_next_record(i18_alpha_idx_h index, bool *is_record)
{
    ...
    if(is_record != NULL)
        *is_record = ((AlphabeticIndex *) index)->nextRecord(status);
    else
                                         ...
                                         i18_alpha_idx_label_type *type)
{
    ...
    *type = (i18_alpha_idx_label_type) ((AlphabeticIndex *) index)->getBucketLabelType();
