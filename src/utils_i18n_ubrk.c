                     ...
                     int32_t text_length, i18n_ubreak_iterator_h *break_iter)
{
    ...
    *break_iter =
        (i18n_ubreak_iterator_h) ubrk_open((UBreakIteratorType) type, locale, text, text_length,
                                           &icu_error);
...
int i18n_ubrk_create_rules(const i18n_uchar *rules, int32_t rules_length, const i18n_uchar *text,
                           int32_t text_length, i18n_ubreak_iterator_h *break_iter,
                           i18n_uparse_error_s *parse_err)
{
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    *break_iter =
        (i18n_ubreak_iterator_h) ubrk_openRules(rules, rules_length, text, text_length,
                                                (UParseError *) parse_err, &icu_error);
...
int i18n_ubrk_safe_clone(const i18n_ubreak_iterator_h break_iter, void *stack_buffer,
                         int32_t *p_buffer_size, i18n_ubreak_iterator_h *break_iter_clone)
{
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    *break_iter_clone =
        (i18n_ubreak_iterator_h) ubrk_safeClone((const UBreakIterator *)break_iter, stack_buffer,
                                                p_buffer_size, &icu_error);
...
int i18n_ubrk_set_text(i18n_ubreak_iterator_h break_iter, const i18n_uchar *text,
                       int32_t text_length)
{
...
int32_t i18n_ubrk_get_rule_status_vec(i18n_ubreak_iterator_h break_iter, int32_t *fill_in_vec,
                                      int32_t capacity)
{
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    int32_t result_ubrk_getRuleStatusVec =
        ubrk_getRuleStatusVec((UBreakIterator *) break_iter, fill_in_vec, capacity, &icu_error);
                                         ...
                                         i18n_ulocale_data_locale_type_e type)
{
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    const char *result_ubrk_getLocaleByType =
        ubrk_getLocaleByType((const UBreakIterator *)break_iter, type, &icu_error);
