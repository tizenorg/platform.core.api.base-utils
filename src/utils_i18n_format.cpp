...
int i18n_measure_format(i18n_formattable_h formattable, char **append_to, char **ustring_format)
{
    ...
    const UnicodeString unicode_append_to(append_to);

    UnicodeString result = Format::fomat((Formattable *) formattable, unicode_append_to, status);
...
int i18n_measure_parse_object(char **source, i18n_formattable_h *result)
{
    ...
    Format::parseObject(unicode_source, f);
