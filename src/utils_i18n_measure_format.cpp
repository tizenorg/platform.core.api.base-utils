...
int i18n_measure_format_create_from_other(i18n_measure_format_h *measure_format, const i18n_measure_format_h other)
{
    ...
    MeasureFormat other_copy = *((MeasureFormat *) other);
    *measure_format = &other_copy;
    retv_if(*measure_format == NULL, I18N_ERROR_OUT_OF_MEMORY);
...
int i18n_measure_format_format_measures(i18n_measure_format_h measure_format, i18n_measure_h measures, int32_t measure_count, char **append_to, i18n_field_position_h field_position)
{
    ...
    UnicodeString result = ((MeasureFormat *) measure_format)->formatMeasures((const Measure *) measures, measure_count, unicode_append_to, (FieldPosition &) field_position, status);
    const UChar *uchar_result = result.getTerminatedBuffer();
...
int i18n_measure_format_format_measures_per(i18n_measure_format_h measure_format, i18n_measure_h measures, int32_t measure_count, i18n_measure_unit_h measure_unit, char **append_to, i18n_field_position_h field_position)
{
    ...
    UnicodeString result = ((MeasureFormat *) measure_format)->formatMeasuresPer((const Measure *) measures, measure_count, (const MeasureUnit &) measure_unit, unicode_append_to, (FieldPosition &) field_position, status);
    const UChar *uchar_result = result.getTerminatedBuffer();
