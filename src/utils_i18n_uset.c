...
int i18n_uset_create_pattern_options(const i18n_uchar *pattern, int32_t pattern_length,
                                     uint32_t options, i18n_uset_h *set)
{
    UErrorCode icu_error = U_ZERO_ERROR;
    i18n_error_code_e i18n_error;
...
int32_t i18n_uset_apply_pattern(i18n_uset_h set, const i18n_uchar *pattern, int32_t pattern_length,
                                uint32_t options)
{
    if (set == NULL) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
    ...
    int32_t result_uset_applyPattern =
        uset_applyPattern((USet *) set, pattern, pattern_length, options, &icu_error);
    ERR_MAPPING(icu_error, i18n_error);
    I18N_ERR(i18n_error);
...
int i18n_uset_apply_int_property_value(i18n_uset_h set, i18n_uchar_uproperty_e prop, int32_t value)
{
    ...
    if (prop != I18N_UCHAR_GENERAL_CATEGORY_MASK &&
        (value <= I18N_UCHAR_INVALID_CODE || value >= I18N_UCHAR_OTHER_PROPERTY_LIMIT))
        return I18N_ERROR_INVALID_PARAMETER;
...
int i18n_uset_apply_property_alias(i18n_uset_h set, const i18n_uchar *prop, int32_t prop_length,
                                   const i18n_uchar *value, int32_t value_length)
{
    if (set == NULL)
        return I18N_ERROR_INVALID_PARAMETER;
...
i18n_ubool i18n_uset_resembles_pattern(const i18n_uchar *pattern, int32_t pattern_length,
                                       int32_t pos)
{
...
int32_t i18n_uset_to_pattern(const i18n_uset_h set, i18n_uchar *result, int32_t result_capacity,
                             i18n_ubool escape_unprintable)
{
    ...
    int32_t result_uset_toPattern =
        uset_toPattern((const USet *)set, result, result_capacity, escape_unprintable, &icu_error);
    ERR_MAPPING(icu_error, i18n_error);
    I18N_ERR(i18n_error);
...
int32_t i18n_uset_get_item(const i18n_uset_h set, int32_t item_index, i18n_uchar32 *start,
                           i18n_uchar32 *end, i18n_uchar *str, int32_t str_capacity)
{
    ...
    int32_t result_uset_getItem =
        uset_getItem((const USet *)set, item_index, start, end, str, str_capacity, &icu_error);
    ERR_MAPPING(icu_error, i18n_error);
    I18N_ERR(i18n_error);
...
i18n_ubool i18n_uset_contains_all_code_points(const i18n_uset_h set, const i18n_uchar *str,
                                              int32_t str_len)
{
    if (set == NULL) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
...
int32_t i18n_uset_span(const i18n_uset_h set, const i18n_uchar *str, int32_t length,
...
int32_t i18n_uset_span_back(const i18n_uset_h set, const i18n_uchar *str, int32_t length,
                            i18n_uset_span_condition_e span_condition)
{
    if (set == NULL) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
...
int32_t i18n_uset_span_utf8(const i18n_uset_h set, const char *str, int32_t length,
                            i18n_uset_span_condition_e span_condition)
{
    if (set == NULL) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
...
int32_t i18n_uset_span_back_utf8(const i18n_uset_h set, const char *str, int32_t length,
                                 i18n_uset_span_condition_e span_condition)
{
    if (set == NULL) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
...
int32_t i18n_uset_serialize(const i18n_uset_h set, uint16_t *dest, int32_t dest_capacity)
{
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    int32_t result_uset_serialize =
        uset_serialize((const USet *)set, dest, dest_capacity, &icu_error);
    ERR_MAPPING(icu_error, i18n_error);
    I18N_ERR(i18n_error);
...
i18n_ubool i18n_uset_get_serialized_set(const uint16_t *src, int32_t src_length,
...
i18n_ubool i18n_uset_get_serialized_range(const i18n_userialized_set_s *set, int32_t range_index,
                                          i18n_uchar32 *p_start, i18n_uchar32 *p_end)
{
    if (set == NULL) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
        return false;
    ...
    if (range_index < 0
        || range_index > uset_getSerializedRangeCount((const USerializedSet *)set) - 1) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
        return false;
    }
