...
int i18n_ucalendar_create(const i18n_uchar *zone_id, int32_t len, const char *locale,
						  i18n_ucalendar_type_e type, i18n_ucalendar_h *calendar)
{
...
int i18n_ucalendar_add(i18n_ucalendar_h calendar, i18n_ucalendar_date_fields_e field,
					   int32_t amount)
{
	retv_if(calendar == NULL, I18N_ERROR_INVALID_PARAMETER);
...
int i18n_ucalendar_is_equivalent_to(const i18n_ucalendar_h calendar1,
									const i18n_ucalendar_h calendar2, i18n_ubool *equiv)
{
...
int i18n_ucalendar_get(const i18n_ucalendar_h calendar, i18n_ucalendar_date_fields_e field,
					   int32_t *val)
{
...
int i18n_ucalendar_get_attribute(i18n_ucalendar_h calendar, i18n_ucalendar_attribute_e attr,
								 int32_t *val)
{
	retv_if(calendar == NULL || val == NULL, I18N_ERROR_INVALID_PARAMETER);
...
int i18n_ucalendar_get_timezone_displayname(const i18n_ucalendar_h calendar,
											...
											const char *locale, i18n_uchar *result,
											int32_t result_len, int32_t *buf_size_needed)
{
	retv_if(calendar == NULL || result == NULL
			|| buf_size_needed == NULL, I18N_ERROR_INVALID_PARAMETER);

	i18n_error_code_e i18n_error;
	UErrorCode icu_error = U_ZERO_ERROR;
	*buf_size_needed =
		ucal_getTimeZoneDisplayName(calendar, type, locale, result, result_len, &icu_error);
	ERR_MAPPING(icu_error, i18n_error);
	I18N_ERR(i18n_error);
...
int i18n_ucalendar_set_attribute(i18n_ucalendar_h calendar, i18n_ucalendar_attribute_e attr,
								 int32_t val)
{
	retv_if(calendar == NULL, I18N_ERROR_INVALID_PARAMETER);
...
int i18n_ucalendar_set_date_time(i18n_ucalendar_h calendar, int32_t year, int32_t month,
								 int32_t date, int32_t hour, int32_t min, int32_t sec)
{
	retv_if(calendar == NULL, I18N_ERROR_INVALID_PARAMETER);
...
int32_t i18n_ucalendar_get_field_difference(i18n_ucalendar_h calendar, i18n_udate target,
...
int i18n_ucalendar_timezone_id_enumeration_create(i18n_system_timezone_type_e zone_type,
												  const char *region, const int32_t *raw_offset,
												  i18n_uenumeration_h *enumeration)
{
	...
	UErrorCode icu_error = U_ZERO_ERROR;
	*enumeration =
		(i18n_uenumeration_h) ucal_openTimeZoneIDEnumeration(zone_type, region, raw_offset,
															 &icu_error);
	ERR_MAPPING(icu_error, i18n_error);
	I18N_ERR(i18n_error);
...
int32_t i18n_ucalendar_get_default_timezone(i18n_uchar *result, int32_t result_capacity)
{
	i18n_error_code_e i18n_error;
	UErrorCode icu_error = U_ZERO_ERROR;
	int32_t result_ucal_getDefaultTimeZone =
		ucal_getDefaultTimeZone(result, result_capacity, &icu_error);
	ERR_MAPPING(icu_error, i18n_error);
	I18N_ERR(i18n_error);
...
int i18n_ucalendar_set_timezone(i18n_ucalendar_h calendar, const i18n_uchar *zone_id,
								int32_t length)
{
	if (calendar == NULL)
		return I18N_ERROR_INVALID_PARAMETER;
...
int32_t i18n_ucalendar_get_timezone_id(const i18n_ucalendar_h calendar, i18n_uchar *result,
									   int32_t result_length)
{
	...
	i18n_error_code_e i18n_error;
	UErrorCode icu_error = U_ZERO_ERROR;
	int32_t result_ucal_getTimeZoneID =
		ucal_getTimeZoneID(calendar, result, result_length, &icu_error);
	ERR_MAPPING(icu_error, i18n_error);
	I18N_ERR(i18n_error);
...
int i18n_ucalendar_roll(i18n_ucalendar_h calendar, i18n_ucalendar_date_fields_e field,
						int32_t amount)
{
	if (calendar == NULL)
		return I18N_ERROR_INVALID_PARAMETER;
...
int32_t i18n_ucalendar_get_canonical_timezone_id(const i18n_uchar *id, int32_t length,
												 i18n_uchar *result, int32_t result_capacity,
												 i18n_ubool *is_system_id)
{
	...
	i18n_error_code_e i18n_error;
	UErrorCode icu_error = U_ZERO_ERROR;
	int32_t result_ucal_getCanonicalTimeZoneID =
		ucal_getCanonicalTimeZoneID(id, length, result, result_capacity, is_system_id, &icu_error);
	ERR_MAPPING(icu_error, i18n_error);
	I18N_ERR(i18n_error);
...
int i18n_ucalendar_get_keyword_values_for_locale(const char *key, const char *locale,
												 ...
												 i18n_uenumeration_h *enumeration)
{
	...
	UErrorCode icu_error = U_ZERO_ERROR;
	*enumeration =
		(i18n_uenumeration_h) ucal_getKeywordValuesForLocale(key, locale, commonly_used,
															 &icu_error);
	ERR_MAPPING(icu_error, i18n_error);
	I18N_ERR(i18n_error);
											  ...
											  i18n_ucalendar_days_of_week_e day_of_week)
{
	...
	i18n_error_code_e i18n_error;
	UErrorCode icu_error = U_ZERO_ERROR;
	int32_t result_ucal_getWeekendTransition =
		ucal_getWeekendTransition(calendar, day_of_week, &icu_error);
	ERR_MAPPING(icu_error, i18n_error);
	I18N_ERR(i18n_error);
													   ...
													   i18n_udate *transition)
{
	...
	i18n_error_code_e i18n_error;
	UErrorCode icu_error = U_ZERO_ERROR;
	i18n_ubool result_ucal_getTimeZoneTransitionDate =
		ucal_getTimeZoneTransitionDate(calendar, type, transition, &icu_error);
	ERR_MAPPING(icu_error, i18n_error);
	I18N_ERR(i18n_error);
