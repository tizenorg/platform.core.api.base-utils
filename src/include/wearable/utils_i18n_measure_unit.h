 ...
 * @deatils Function invokes the default constructor.
 * @since_tizen 3.0
 *
...
/**
 * @brief Creates the measure unit object created from the other measure unit object.
 * @deatils Function invokes the copy constructor.
 * @since_tizen 3.0
 *
 * @param[out] measure_unit  The created measure unit object
 * @param[in]  other         The measure unit object from which the new object is created
 *
 * @return Error code. Error codes not listed below are described in #i18n_error_code_e
 * @retval #I18N_ERROR_NONE Successful
 * @retval #I18N_ERROR_INVALID_PARAMETER Invalid function parameter
 ...
 * @since_tizen 3.0
 *
 * @param[in]  measure_unit  The measure unit object from which the new object is created
 * @param[out] clone         The created measure unit object
 *
 * @return Error code. Error codes not listed below are described in #i18n_error_code_e
 * @retval #I18N_ERROR_NONE Successful
 * @retval #I18N_ERROR_INVALID_PARAMETER Invalid function parameter
 ...
 *
 * @param[in]  measure_unit  The measure unit object
 * @param[out] subtype       The measure unit object sub type
 *
 * @return Error code. Error codes not listed below are described in #i18n_error_code_e
 * @retval #I18N_ERROR_NONE Successful
 * @retval #I18N_ERROR_INVALID_PARAMETER Invalid function parameter
 ...
 * @param[out] dest_capacity  The number of the measure unit instances available at dest_array
 *
 * @return Error code. Error codes not listed below are described in #i18n_error_code_e
 * @retval #I18N_ERROR_NONE Successful
 * @retval #I18N_ERROR_INVALID_PARAMETER Invalid function parameter
 ...
 * @details Caller owns the returned value and must delete it when finished using it.
 * @since_tizen 3.0
 *
