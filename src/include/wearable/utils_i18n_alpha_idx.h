 ...
 * @remarks The created object should be released by the caler with the
 ...
 * @param[out] is_bucket A flag set to @c true if the iteration succeeded,
 ...
 * @retval #I18N_ERROR_INVALID_PARAMETER Invalid function parameter
 */
int i18n_alpha_idx_next_bucket(i18_alpha_idx_h index, bool *is_bucket);
 ...
 * @param[out] is_record A flag set to @c true if the iteration succeeded,
 *                       or @c false at the end of iteration.
 *
 * @return @c 0 on success, otherwise a negative error value
 * @retval #I18N_ERROR_NONE Successful
 * @retval #I18N_ERROR_INVALID_PARAMETER Invalid function parameter
 */
int i18n_alpha_idx_next_record(i18_alpha_idx_h index, bool *is_record);
 ...
 * @retval #I18N_ERROR_INVALID_PARAMETER Invalid function parameter
 */
int i18n_alpha_idx_get_bucket_index(i18_alpha_idx_h index, const char *item_name, 
