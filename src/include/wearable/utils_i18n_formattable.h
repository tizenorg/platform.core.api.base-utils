 ...
 * @remarks The created object should be released by the caller with the #i18n_formattable_destroy() function.
 ...
 * @remarks The cloned object should be released by the caller with the #i18n_formattable_destroy() function.
 * @param[in] formattable  A handle to the formattable object
 ...
 *          The obtained array should be released by the caller with the free() function.
 * @param[in] formattable  A handle to the formattable object
 ...
 *          error code and the value is set to @c NULL.
 *
 *          The obtained array should be released by the caller with the free() function.
 * @param[in] formattable  A handle to the formattable object
