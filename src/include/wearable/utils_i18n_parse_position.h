 ...
 * @retval #I18N_ERROR_OUT_OF_MEMORY Out of memory
 */
int i18n_parse_position_create_form_other(i18n_parse_position_h *parse_position, const i18n_parse_position_h other)
{
    retv_if(parse_position == NULL || other == NULL, I18N_ERROR_INVALID_PARAMETER);

    *parse_position = new ParsePosition((ParsePosition &) other);
    retv_if(parse_position == NULL, I18N_ERROR_OUT_OF_MEMORY);
 ...
 * @since_tizen 3.0
 *
 * @param[out] parse_position  The parse position object from which the new object is created
 * @param[in]  clone           The created parse position object
 *
 * @retval #I18N_ERROR_NONE Successful
 * @retval #I18N_ERROR_INVALID_PARAMETER Invalid function parameter
 * @retval #I18N_ERROR_OUT_OF_MEMORY Out of memory
