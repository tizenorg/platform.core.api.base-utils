 ...
 * @param[in] d             The #i18n_udate instance
 * @param[in] flag          The flag to indicate that this is a date. Always set it to #I18N_FORMATTABLE_IS_DATE.
 * @param[out] formattable  A pointer to a handle to the newly created formattable object
 * @return The error code
 */
int i18n_formattable_create_with_udate(i18n_udate d, i18n_formattable_is_date_e flag, i18n_formattable_h *formattable);
...
/**
 * @brief Creates a new #i18n_formattable_h handle with an array of #i18n_formattable_h handles.
...
/**
 * @brief Creates a new #i18n_formattable_h handle with other #i18n_formattable_h handle.
...
/**
 * @brief Sets and adopts the array value and count of this object and
...
/**
 * @brief Clones the given formattable handle with the related object to the @a clone handle.
 * @details Clones can be used concurrently in multiple threads.
 * @remarks The cloned object need to be released by the caller.
 * @param[in] formattable  A handle to the formattable object
 * @param[out] clone       A pointer to a handle to the formattable object which will be filled with a copy of the @a formattable handle.
 * @return The error code
 */
 ...
 * @remarks If this object is not of type #I18N_FORMATTABLE_K_ARRAY then the result is undefined.
 * @param[in] formattable  A handle to the formattable object
 * @param[out] array       A pointer to an array of #i18n_formattable_h handles
 * @param[out] count       A pointer to an int32_t variable which will be filled with the number of array's elements
 * @return The error code
 */
 ...
 * @remarks If this object is not of type #I18N_FORMATTABLE_K_DATE then the result is undefined.
 * @param[in] formattable  A handle to the formattable object
 ...
 * @remarks If this object is not of type #I18N_FORMATTABLE_K_DOUBLE then the result is undefined.
 * @param[in] formattable  A handle to the formattable object
 ...
 * @remarks If this object is not of type #I18N_FORMATTABLE_K_INT64 then the result is undefined.
 * @param[in] formattable  A handle to the formattable object
 ...
 * @details If the magnitude is too large to fit in a long,
 *          then the maximum or minimum long value,
 *          as appropriate, is set to @value variable and the #I18N_ERROR_INVALID_FORMAT
 *          error code is returned by the function.
 *
 *          If this object is of type #I18N_FORMATTABLE_K_INT64 and
 *          it fits within a long, then no precision is lost.
 *
 *          If it is of type #I18N_FORMATTABLE_K_DOUBLE,
 *          then a conversion is peformed, with truncation of any fractional part.
 *
 *          If this object is neither a numeric type nor a Measure, then 0 is returned and
 *          the function returns #I18N_ERROR_INVALID_FORMAT error code.
 * @param[in] formattable  A handle to the formattable object
 ...
 *          error code and the value is set to a bogus string.
 * @param[in] formattable  A handle to the formattable object
...
/**
 * @brief Sets the variable pointed by the @a is_numeric pointer to @c true if the data type of
          the given formattable object is #I18N_FORMATTABLE_K_DOUBLE, #I18N_FORMATTABLE_K_LONG,
          #I18N_FORMATTABLE_K_INT64.
 * @param[in] formattable  A handle to the formattable object
 * @param[out] is_numeric  A pointer to a boolean variable which will be filled by the function
 * @return The error code
 */
int i18n_formattable_is_numeric(i18n_formattable_h formattable, bool *is_numeric);

/**
 * @brief Sets the variable pointed by the @a not_equal pointer to @c true if the given @a formattable object is not equal to the given @a other formattable object.
 * @param[in] formattable  A handle to the formattable object
 * @param[in] other        A handle to the other formattable object
 * @param[out] not_equal   A pointer to a boolean variable which will be filled by the function
 * @return The error code
 */
int i18n_formattable_not_equal(i18n_formattable_h formattable, i18n_formattable_h other, bool *not_equal);

/**
 * @brief Sets the variable pointed by the @a equal pointer to @c true if the given @a formattable object is equal to the given @a other formattable object.
 * @param[in] formattable  A handle to the formattable object
 * @param[in] other        A handle to the other formattable object
 * @param[out] equal       A pointer to a boolean variable which will be filled by the function
 * @return The error code
 */
int i18n_formattable_equal(i18n_formattable_h formattable, i18n_formattable_h other, bool *equal);

/**
 * @brief Sets the object pointed by the @a element pointer to the element at the @a index position in the array stored by the given formattable object (if its type is #I18N_FORMATTABLE_K_ARRAY).
 * @remarks If this object is not of type #I18N_FORMATTABLE_K_ARRAY then the result is undefined.
 * @param[in] formattable  A handle to the formattable object
 * @param[in] index        A number representing the position in the array from which the element should be obtained
 * @param[out] element     A pointer to a handle to the formattable object which will be filled by the function
 * @return The error code
 */
int i18n_formattable_element_at(i18n_formattable_h formattable, int32_t index, i18n_formattable_h *element);

/**
 * @brief Sets the array value and count of the given formattable object and changes the
 *        type to #I18N_FORMATTABLE_K_ARRAY.
 * @param[in] formattable  A handle to the formattable object
...
/**
 * @brief Sets the date value of the given formattable object and changes the type to
 *        the #I18N_FORMATTABLE_K_DATE.
 * @param[in] formattable  A handle to the formattable object
...
/**
 * @brief Sets the double value of the given formattable object and changes the type to
 *        the #I18N_FORMATTABLE_K_DOUBLE.
 * @param[in] formattable  A handle to the formattable object
...
/**
 * @brief Sets the int64 value of the given formattable object and changes the type to
 *        the #I18N_FORMATTABLE_K_INT64.
 * @param[in] formattable  A handle to the formattable object
...
/**
 * @brief Sets the long value of the given formattable object and changes the type to
 *        the #I18N_FORMATTABLE_K_LONG.
 * @param[in] formattable  A handle to the formattable object
...
/**
 * @brief Sets the string value of the given formattable object and changes the type to
 *        the #I18N_FORMATTABLE_K_STRING.
 * @param[in] formattable     A handle to the formattable object
