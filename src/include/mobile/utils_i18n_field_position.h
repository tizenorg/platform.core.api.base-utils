 ...
 * @brief Field Position is a simple class used by Format and its subclasses to identify fields in formatted output. 
...
/**
 * @brief Creates a field position object from the other measure object.
 * @deatils Fields are identified by constants, whose names typically end with _FIELD,
 *          in the various subclasses of Format.
 ...
 * @retval #I18N_ERROR_OUT_OF_MEMORY Out of memory
 */
int i18n_field_position_create_form_other(i18n_field_position_h *field_position, const i18n_field_position_h other);
 ...
 * @since_tizen 3.0
 *
 * @param[out] field_position  The field position object from which the new object is created
 * @param[in]  clone           The created field position object
 *
 * @retval #I18N_ERROR_NONE Successful
 * @retval #I18N_ERROR_INVALID_PARAMETER Invalid function parameter
 * @retval #I18N_ERROR_OUT_OF_MEMORY Out of memory
 ...
 * @since_tizen 3.0
 *
 * @param[out] field_position  The field_position object
