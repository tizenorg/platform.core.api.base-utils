...
i18n_uchar *i18n_ustring_find_first(const i18n_uchar *s, int32_t length,
                                    const i18n_uchar *sub_string, int32_t sub_length)
{
    if (s == NULL || length < -1) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
        return NULL;
...
i18n_uchar *i18n_ustring_find_last(const i18n_uchar *s, int32_t length,
                                   const i18n_uchar *sub_string, int32_t sub_length)
{
    if (s == NULL || length < -1) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
...
i18n_uchar *i18n_ustring_tokenizer_r(i18n_uchar *src, const i18n_uchar *delim,
...
int32_t i18n_ustring_compare_binary_order(const i18n_uchar *s1, int32_t length1,
                                          const i18n_uchar *s2, int32_t length2,
...
int32_t i18n_ustring_case_compare_with_length(const i18n_uchar *s1, int32_t length1,
                                              const i18n_uchar *s2, int32_t length2,
                                              uint32_t options, i18n_error_code_e *i18n_error)
{
...
int32_t i18n_ustring_compare_n_code_point_order(const i18n_uchar *s1, const i18n_uchar *s2,
                                                int32_t n)
{
    if (s1 == NULL || s2 == NULL) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
...
int32_t i18n_ustring_case_compare_n(const i18n_uchar *s1, const i18n_uchar *s2, int32_t n,
                                    uint32_t options)
{
    if (s1 == NULL || s2 == NULL) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
...
int32_t i18n_ustring_mem_case_compare(const i18n_uchar *s1, const i18n_uchar *s2, int32_t length,
                                      uint32_t options)
{
    if (s1 == NULL || s2 == NULL) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
...
int32_t i18n_ustring_mem_compare_code_point_order(const i18n_uchar *s1, const i18n_uchar *s2,
                                                  int32_t count)
{
    if (s1 == NULL || s2 == NULL) {
        set_last_result(I18N_ERROR_INVALID_PARAMETER);
...
i18n_uchar32 i18n_ustring_unescape_at(i18n_ustring_unescape_char_at_cb char_at, int32_t *offset,
...
int32_t i18n_ustring_to_upper(i18n_uchar *dest, int32_t dest_capacity, const i18n_uchar *src,
                              int32_t src_len, const char *locale, i18n_error_code_e *i18n_error)
{
    UErrorCode icu_error = U_ZERO_ERROR;
...
int32_t i18n_ustring_to_lower(i18n_uchar *dest, int32_t dest_capacity, const i18n_uchar *src,
                              int32_t src_len, const char *locale, i18n_error_code_e *i18n_error)
{
    UErrorCode icu_error = U_ZERO_ERROR;
...
int32_t i18n_ustring_to_title(i18n_uchar *dest, int32_t dest_capacity, const i18n_uchar *src,
                              ...
                              const char *locale, i18n_error_code_e *i18n_error)
{
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    int32_t result =
        u_strToTitle(dest, dest_capacity, src, src_len, (UBreakIterator *) title_iter, locale,
                     &icu_error);
    *i18n_error = _i18n_error_mapping(icu_error);
...
int32_t i18n_ustring_to_title_new(i18n_uchar *dest, int32_t dest_capacity, const i18n_uchar *src,
                                  int32_t src_len, i18n_ubreak_iterator_h title_iter,
                                  const char *locale)
{
...
int32_t i18n_ustring_fold_case(i18n_uchar *dest, int32_t dest_capacity, const i18n_uchar *src,
                               int32_t src_len, uint32_t options, i18n_error_code_e *i18n_error)
{
    if (src == NULL) {
        *i18n_error = I18N_ERROR_INVALID_PARAMETER;
        return 0;
...
wchar_t *i18n_ustring_to_WCS(wchar_t *dest, int32_t dest_capacity, int32_t *dest_len,
                             const i18n_uchar *src, int32_t src_len,
...
i18n_uchar *i18n_ustring_from_WCS(i18n_uchar *dest, int32_t dest_capacity, int32_t *dest_len,
                                  const wchar_t *src, int32_t src_len,
                                  i18n_error_code_e *i18n_error)
{
    if (src == NULL) {
        *i18n_error = I18N_ERROR_INVALID_PARAMETER;
...
char *i18n_ustring_to_UTF8(char *dest, int32_t dest_capacity, int32_t *dest_len,
                           const i18n_uchar *src, int32_t src_len, i18n_error_code_e *i18n_error)
{
    if (src == NULL) {
        *i18n_error = I18N_ERROR_INVALID_PARAMETER;
        return NULL;
...
i18n_uchar *i18n_ustring_from_UTF8(i18n_uchar *dest, int32_t dest_capacity, int32_t *dest_len,
                                   const char *src, int32_t src_len, i18n_error_code_e *i18n_error)
{
    if (src == NULL) {
        *i18n_error = I18N_ERROR_INVALID_PARAMETER;
        return NULL;
...
char *i18n_ustring_to_UTF8_with_sub(char *dest, int32_t dest_capacity, int32_t *dest_len,
                                    const i18n_uchar *src, int32_t src_len, i18n_uchar32 sub_char,
                                    int32_t *num_substitutions, i18n_error_code_e *i18n_error)
{
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    char *result =
        u_strToUTF8WithSub(dest, dest_capacity, dest_len, src, src_len, sub_char, num_substitutions,
                           &icu_error);
    *i18n_error = _i18n_error_mapping(icu_error);
...
i18n_uchar *i18n_ustring_from_UTF8_with_sub(i18n_uchar *dest, int32_t dest_capacity,
                                            int32_t *dest_len, const char *src, int32_t src_len,
                                            i18n_uchar32 sub_char, int32_t *num_substitutions,
                                            i18n_error_code_e *i18n_error)
{
    if (src == NULL) {
        *i18n_error = I18N_ERROR_INVALID_PARAMETER;
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    i18n_uchar *result =
        u_strFromUTF8WithSub(dest, dest_capacity, dest_len, src, src_len, sub_char,
                             num_substitutions, &icu_error);
    *i18n_error = _i18n_error_mapping(icu_error);

    return result;
}

i18n_uchar *i18n_ustring_from_UTF8_lenient(i18n_uchar *dest, int32_t dest_capacity,
                                           int32_t *dest_len, const char *src, int32_t src_len,
                                           i18n_error_code_e *i18n_error)
{
    if (src == NULL) {
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    i18n_uchar *result =
        u_strFromUTF8Lenient(dest, dest_capacity, dest_len, src, src_len, &icu_error);
    *i18n_error = _i18n_error_mapping(icu_error);

    return result;
}

i18n_uchar32 *i18n_ustring_to_UTF32(i18n_uchar32 *dest, int32_t dest_capacity, int32_t *dest_len,
                                    const i18n_uchar *src, int32_t src_len,
                                    i18n_error_code_e *i18n_error)
{
    if (src == NULL) {
...
i18n_uchar *i18n_ustring_from_UTF32(i18n_uchar *dest, int32_t dest_capacity, int32_t *dest_len,
                                    const i18n_uchar32 *src, int32_t src_len,
                                    i18n_error_code_e *i18n_error)
{
    if (src == NULL) {
        *i18n_error = I18N_ERROR_INVALID_PARAMETER;
...
i18n_uchar32 *i18n_ustring_to_UTF32_with_sub(i18n_uchar32 *dest, int32_t dest_capacity,
                                             int32_t *dest_len, const i18n_uchar *src,
                                             int32_t src_len, i18n_uchar32 sub_char,
                                             ...
                                             i18n_error_code_e *i18n_error)
{
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    i18n_uchar32 *result =
        u_strToUTF32WithSub(dest, dest_capacity, dest_len, src, src_len, sub_char,
                            num_substitutions, &icu_error);
    *i18n_error = _i18n_error_mapping(icu_error);
...
i18n_uchar *i18n_ustring_from_UTF32_with_sub(i18n_uchar *dest, int32_t dest_capacity,
                                             int32_t *dest_len, const i18n_uchar32 *src,
                                             int32_t src_len, i18n_uchar32 sub_char,
                                             int32_t *num_substitutions,
                                             i18n_error_code_e *i18n_error)
{
    ...
    UErrorCode icu_error = U_ZERO_ERROR;
    i18n_uchar *result =
        u_strFromUTF32WithSub(dest, dest_capacity, dest_len, src, src_len, sub_char,
                              num_substitutions, (UErrorCode *) & icu_error);
    *i18n_error = _i18n_error_mapping(icu_error);
